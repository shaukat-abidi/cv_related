...
fprintf(' \n Finished processing. \n');
save_filename = strcat(save_path,'for_training_class2_class10.mat');
save_filename_1 = strcat(save_path,'fids_class2_class10.mat');
save_filename_2 = strcat(save_path,'superpixel_size_class2_class10.mat');
