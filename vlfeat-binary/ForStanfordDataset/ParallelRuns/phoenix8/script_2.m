...
load_filename_1 = strcat(save_path,'for_training_class2_class10.mat');
load_filename_2 = strcat(save_path,'fids_class2_class10.mat');
...
fName = strcat(save_path,'training_file_class2_class10.txt');
